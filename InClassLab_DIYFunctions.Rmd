...
fahrenheight_to_c <- function(tempf) {
  (tempf - 32)*5/9
}
fahrenheight_to_c(32)
fahrenheight_to_c(212)
...
```{r}
absolute_val <- function(some_number) {
  if (some_number < 0) {
